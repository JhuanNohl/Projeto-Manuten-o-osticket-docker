...
/* ZK-EQUIP:BEGIN — Customização ZKTeco: módulo de múltiplos equipamentos por ticket.
   Carregado aqui (fim do main.inc.php) pois o ambiente já está pronto
   (TABLE_PREFIX, classe Signal, $ost). Ver CUSTOMIZACOES_OSTICKET.md. */
