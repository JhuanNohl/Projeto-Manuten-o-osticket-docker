...
// Criação de conta é parte do mesmo fluxo "porta de entrada" do login:
// sem menu de navegação aqui também (só some para quem já tem conta
// confirmada gerenciando o perfil/"profile.inc.php", que continua com
// o menu normal de cliente logado).
if (in_array($inc, array('register.inc.php', 'register.confirm.inc.php')))
    $nav = false;
