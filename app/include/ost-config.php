...
define('SECRET_SALT','5R6PGnyATi0Esr0W1U04LWD30nz0HVNH');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','juliano.zkteco@gmail.com');
...
# ZK/Docker: credenciais lidas do ambiente (definidas no docker-compose a
# partir do .env). Fallbacks garantem funcionamento; a SENHA vem só do env
# (sem senha fixa neste arquivo). No XAMPP original nada disso foi alterado.
define('DBHOST', getenv('OST_DBHOST') ?: 'db');
define('DBNAME', getenv('OST_DBNAME') ?: 'zkteco_manutencao');
define('DBUSER', getenv('OST_DBUSER') ?: 'osticket');
