...
<head>
    ...
    <?php /* ZK: Bootstrap Glyphicons (só @font-face + .glyphicon-*, ver
       app/css/glyphicons.css) — ícones dos links do cabeçalho (Perfil/
       Sair/Entrar). Mesma lib usada no painel da equipe
       (include/staff/header.inc.php). */ ?>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/glyphicons.css?zk20260820a" media="all"/>
    <?php /* ZK: cache-buster próprio do theme.css — incrementar a cada
       mudança de CSS pra não depender de Ctrl+F5 do cliente. */ ?>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?zk20260821b" media="screen"/>
    ...
    <?php /* ZK: cache-buster próprio (não o a1114e5 global) — incrementar
       a cada mudança neste arquivo, mesma regra do zkteco-scp.css. */ ?>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor-osticket.js?zk20260820a"></script>
            ...
            <p>
             <?php
                if ($thisclient && is_object($thisclient) && $thisclient->isValid()
                 ...
                 ?>
                <a href="<?php echo ROOT_PATH; ?>profile.php"><i class="glyphicon glyphicon-user"></i> <?php echo __('Profile'); ?></a> |
                <a href="<?php echo ROOT_PATH; ?>tickets.php"><?php echo sprintf(__('Tickets <b>(%d)</b>'), $thisclient->getNumTickets()); ?></a> -
                <a href="<?php echo $signout_url; ?>"><i class="glyphicon glyphicon-log-out"></i> <?php echo __('Sign Out'); ?></a>
            <?php
            } elseif($nav) {
                ...
                if ($thisclient && $thisclient->isValid() && $thisclient->isGuest()) { ?>
                    <a href="<?php echo $signout_url; ?>"><i class="glyphicon glyphicon-log-out"></i> <?php echo __('Sign Out'); ?></a><?php
                }
                elseif ($cfg->getClientRegistrationMode() != 'disabled') { ?>
                    <a href="<?php echo $signin_url; ?>"><i class="glyphicon glyphicon-log-in"></i> <?php echo __('Sign In'); ?></a>
<?php
                }
            } ?>
            </p>
...
<?php }
            ...
            <h1 id="site-title"><?php echo Format::htmlchars($title); ?></h1>
        </div>
        <div class="clear"></div>
        <?php
        if($nav){ ?>
