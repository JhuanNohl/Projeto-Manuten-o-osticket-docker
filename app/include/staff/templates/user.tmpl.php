...
<div id="user-profile" style="display:<?php echo $forms ? 'none' : 'block'; ?>;">
    <div class="zk-user-head">
    <div class="avatar">
    <?php echo $user->getAvatar(); ?>
    </div>
    <div class="zk-user-id">
    <div class="zk-user-name"><b><?php
    echo Format::htmlchars($user->getName()->getOriginal()); ?></b></div>
    <div class="faded">&lt;<?php echo $user->getEmail(); ?>&gt;</div>
    <?php
    if (($org=$user->getOrganization())) { ?>
    <div class="zk-user-org"><?php echo $org->getName(); ?></div>
    <?php
    } ?>
    </div>
    <?php
    if ($ticket) { ?>
    <a class="action-button change-user" style="overflow:inherit"
